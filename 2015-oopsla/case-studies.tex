...
\code{@inline} denotes that the \code{pow} function it self must be inlined at application
 and \code{@ct} requires that the \code{exp} argument is a compile-time view of \code{Int}.
 The application of the function \code{pow} with a constant exponent will produce:
...
Here, in the function application, constant 4 is promoted to \code{ct} by the automatic
conversions. \todo{ref}
...
\todo{not-sure how to achieve this!}
\todo{cite}
