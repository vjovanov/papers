...
\renewcommand{\i}[1]{i #1}
\renewcommand{\j}[1]{j #1}
\renewcommand{\k}[1]{k #1}
\renewcommand{\l}[1]{l #1}
\newcommand{\dynamic}[1]{dynamic\ #1}
\newcommand{\static}[1]{static\ #1}
\newcommand{\inline}[1]{inline\ #1}
\newcommand{\tsv}{\,\vdash\,}
\newcommand{\syntaxfig}[1]{
  \begin{center}$
...
\newcommand{\wff}[1]{\text{wff}\ #1}
\newcommand{\pe}{\leadsto}
\newcommand{\cd}[2]{#1 \leadsto #2}
\newcommand{\e}{\Downarrow}
\newcommand{\calculus}{$F_{i <:}$\xspace}
\newcommand{\smartparagraph}[1]{{\bf #1}}
\newcommand{\tool}{ScalaCT\xspace}
