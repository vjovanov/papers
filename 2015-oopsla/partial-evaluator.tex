...
We have implemented a prototype partial evaluator, formally defined in \sct{sct:partial-evaluation}, and
 according to the \calculus calculus (formally define in \sct{sct:calculus}).
...
\smartparagraph{Functions \code{ct} and \code{inline}} is used at the term level for promoting Scala objects
 and functions into their compile-time views. Without \code{ct} we would not be able
 to instantiate compile-time views of the types. \tabref{tbl:ct-type} shows how
