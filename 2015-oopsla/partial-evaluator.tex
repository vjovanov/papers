...
\end{table*}
 ...
 all arguments of all methods will need to be also compile-time views. On the other hand,
...
% TODO inline/ct as the term level annotation
...
uses partial evaluation to achieve inlining\cite{monnier2003inlining}. This is not the first time that
