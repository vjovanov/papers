...
% Staging (Nielsen, Ocaml, LMS) is a .... It was proven very useful for building
% improving program performance, especially compilers out of interpreters etc.
...
% Staging is Syntactically heavy.
