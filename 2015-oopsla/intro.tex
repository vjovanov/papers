...
% For all notable common frameworks the starting stage is the runtime
 % technique in which Staging (Nielsen, Ocaml, LMS) is a .... It was proven very useful for building
% improving program performance, especially compilers out of interpreters etc. Means to achieve predictable partial evaluation.
