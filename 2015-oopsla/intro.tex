...
% TODO better citations metaOCaml, interpreters to compilers, DSLs
 Multi-stage programming (or \emph{staging}) is a flavor of meta-programming
  ...
  \todo{Staging originates from research on multi-level calculi~\cite{} and can greatly improve performance of programs~\cite{}.}
...
\begin{itemize}
 ...
 type-classes~\cite{oliveira_type_2010,hall_type_1996}.
