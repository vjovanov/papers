...
\begin{multicols}{2}[]
  ...
  % \infrule[\textsc{I-Inline}]
  %   {\Pi \ts \pe{t}{t'}}
  %   {\Pi \ts \pe{\inline{t}}{{\inline{t'}}}}


  \infrule[\textsc{I-TVar}]
    {\Pi \ts T \in \Pi}
    {\Pi \ts \pe{iT}{iT}}

  \infrule[\textsc{I-Rec}]
    {\Pi \ts \pe{\seq{t}}{\seq{t'}}}
    {\Pi \ts \pe{\{ \seq{x = t} \}}{\inline{\{ \seq{x = t'} \}}}}
...
\vspace{4pt}
  ...
  \infrule[\textsc{I-Func}]
    {\Pi \ts \pe{t}{t'} \ \ \ \ \Pi \ts \pe{iT}{jT}}
    {\Pi \ts \pe{(x: iT) \ra t}{\inline{(x: jT) \ra t'}}}

  \infrule[\textsc{I-TAbs}]
    {\Pi,\ X \ts \pe{t}{t'}}
    {\Pi \ts \pe{\i([X <: \j{T_1}] \ra t)}{\inline{([X <: \j{T_1}] \ra t'})}}

  \infrule[\textsc{I-TApp}]
    {\Pi \ts \pe{t}{t'} \ \ \ \ \Pi \ts \pe{iT}{jT}}
    {\Pi \ts \pe{t[\i{T}]}{t'[\j{T}]}}
