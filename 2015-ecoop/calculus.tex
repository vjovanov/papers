\clearpage
\section{Formalization \calculus}
\label{sct:formalization}
...
\syntaxfig{
  ...
  \gap \dynamic{t}                  & \mbox{dynamic view}                  \\
...
\begin{figure}
  ...
  \infrule[\textsc{PE-ISel}]
    {\pe{t}{\inline{\{x = t_x,\ \seq{y = t_y}\}}} \ \ \ \pe{t_x}{t_x'}}
    {\pe{t.x}{t_x'}}

  \infrule[\textsc{PE-Inline}]
    {\pe{t}{t'}}
    {\pe{\inline{t}}{{\inline{t'}}}}

  \infrule[\textsc{PE-Dynamic1}]
    {\pe{t}{\inline{t'}}}
    {\pe{\dynamic{t}}{{t'}}}

  \infrule[\textsc{PE-Dynamic2}]
    {\pe{t}{t'} \ \ \ t' \neq \inline{t''}}
    {\pe{\dynamic{t}}{{\dynamic{t'}}}}

  \infrule[\textsc{PE-Sel}]
    {\pe{t}{t'} \ \ \ t' \neq \inline{\{x = t_x,\ \seq{y = t_y}\}}}
    {\pe{t.x}{t'.x}}

  \infrule[\textsc{PE-IApp}]
    {\pe{t_1}{\inline{x \ra b}} \ \ \ \pe{t_2}{t'_2} \ \ \ \pe{[x \rightarrow t'_2] \; b}{b'} }
    {\pe{t_1 (t_2)}{b'}}
...
\begin{figure}
  ...
  \infrule[\textsc{E-App}]
  {t_1 \e x \ra t \ \ \ \ t_2 \e v \ \ \ \ [x \mapsto v] t \e t'}
  {t_1(t_2) \e t'}

  \infrule[\textsc{E-Sel}]
  {t \e \{ x = t_x,\ \seq{y = t_y}\} \ \ \ \ t_x \e t_x'}
  {t.x \e t_x'}
