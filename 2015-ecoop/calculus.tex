...
\syntaxfig{
  ...
  \i{T},\ \j{T},\ \k{T},\ \l{T} ::= & \lindent{\mbox{Binding-Time Annotated Types:}} \\
...
We also introduce subtyping on binding-time annotated types. Two binding-time annotated
...
and convert inline terms into corresponding dynamic ones. After that we use simple
big-step reduction rules to perform runtime evaluation.
