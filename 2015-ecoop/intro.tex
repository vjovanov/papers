...
\begin{itemize}
 ...
 \item By providing a translation scheme from data types in object oriented languages (polymorphic  classes and methods into the dual views in the \calculus calculus (\sct{sct:scala-translation}).

 \item By demonstrating the usefulness of compile-time views in four case
 studies (\sct{sct:case-studies}): partially evaluating recursion, removing
