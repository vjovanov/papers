...
\title{Polyvariant Staging}
% \subtitle{Avoiding code duplication in sta}

\authorinfo{Vojin Jovanovic \and Eugene Burmako \and Denys Shabalin \and Martin Odersky}{
...
\input{intro.tex}
\input{partial-evaluator.tex}
\input{case-studies.tex}
